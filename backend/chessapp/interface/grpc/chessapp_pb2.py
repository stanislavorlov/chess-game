...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x0e\x63hessapp.proto\x12\x08\x63hessapp\"?\n\x14PredictedMoveRequest\x12\x10\n\x08\x62itboard\x18\x01 \x01(\t\x12\x15\n\ris_white_turn\x18\x02 \x01(\x08\")\n\x15PredictedMoveResponse\x12\x10\n\x08uci_move\x18\x01 \x01(\t2`\n\tAiService\x12S\n\x10GetPredictedMove\x12\x1e.chessapp.PredictedMoveRequest\x1a\x1f.chessapp.PredictedMoveResponseB\x17Z\x15\x65ngineapp/proto;chessb\x06proto3')

_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'chessapp_pb2', _globals)
