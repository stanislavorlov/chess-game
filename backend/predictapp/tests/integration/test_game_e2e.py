...
from predictapp.infrastructure.config.config import Settings
from predictapp.infrastructure.models import GameDocument, GameHistoryDocument

# Configuration
FRONTEND_URL = "http://localhost:4200"
TEST_GAME_NAME = "E2E-Integration-Test-Game"
ARTIFACTS_DIR = "/Users/stanislavorlov/PycharmProjects/chess-game/backend/predictapp/tests/integration/artifacts"
...
async def db_cleanup():
    ...
    load_dotenv(os.path.join(os.path.dirname(__file__), "..", "..", "predictapp", ".env"))
