...
// Attempt to load from `../.env` (if running via `npm run dev`) 
// or `../../.env` (if running `node dist/index.js` inside the `authapp` folder)
...
const PORT = process.env.AUTHAPP_PORT || 3000;
